...
CREATE TABLE IF NOT EXISTS RATING (ID_RESTAURANT INT NOT NULL, username varchar(20) NOT NULL,
                                   GRADE INT NOT NULL, PRIMARY KEY (ID_RESTAURANT, username));

CREATE TABLE IF NOT EXISTS COMMENT (ID_COMMENT TEXT NOT NULL, ID_RESTAURANT INT NOT NULL, username varchar(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS RESERVATION (ID_RESTAURANT INT NOT NULL, ID_USER varchar(20) NOT NULL,
                                  ...
                                  PRIMARY KEY (ID_RESTAURANT, ID_USER,start_date));
